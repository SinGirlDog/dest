 ...
 * 文档列表类_移动端
 *
 * @version        $Id: arc.listview_mobile.class.php 2 09:09 2018年9月9日Z edit by SLJ $
 ...
 * 自由列表类
 *
 * @package          ListView_mobile
 * @subpackage       DedeCMS.Libraries
 * @link             http://www.dedecms.com
 */
class ListView_cross
{
    var $dsql;
    var $dtp;
    var $dtp2;
    ...
    {
        $this->TypeID_orig = $typeid;
        
        global $dsql,$ftp;
        $this->dsql = &$dsql;
        $typeid = $this->GetCrossId($typeid);
        ...
        $this->TypeLink = new TypeLink($this->TypeID_orig);
...
$this->TotalPage = ceil($this->TotalResult/$this->PageSize);
    ...
    function MakeHtml($startpage=1, $makepagesize=0, $isremote=0)
    {
        ...
        //违规的赋值
        $this->Fields['typedir'] = $this->GetCrossOrigTypedir();
        ...
        $imgwidth=120,$imgheight=90,$listtype="all",$orderby="default",$innertext="",$tablewidth="100",$ismake=1,$orderWay='desc')
    {
        ...
        //交叉其他栏目内容却又想用自己的文件路径-
        $cross_orig_typedir = $this->GetCrossOrigTypedir();
        ...
        for($i=0;$i<$row;$i++)
        {
            ...
            for($j=0;$j<$col;$j++)
            {
                if($row = $this->dsql->GetArray("al"))
                {
                    ...
                    //违规的赋值
                    $row['typedir'] = $cross_orig_typedir;
