...
function SelectXML(fname,stype,xmlsel)
{
	...
	if(xmlsel) xmlsel = '&noeditor=yes';
	if(!stype) stype = '';
	window.open("../include/dialog/select_xml.php?f="+fname+"&noeditor=yes&xmlstick="+stype+xmlsel, "popUpxmlsWin", "scrollbars=yes,resizable=yes,statebar=no,width=650,height=400,left="+posLeft+", top="+posTop);
}
