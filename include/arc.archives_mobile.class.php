...
class Archives_mobile
{
    ...
    function __construct($aid)
    {
        ...
        {
            $this->typeID_orig = $arr['typeid'];
            $arr['typeid'] = $this->MobileTypeidSwitch($arr['typeid']);
    ...
    {
        //手机站偷懒的处理
        $this->Fields['typeid'] = $this->typeID_orig;
        ...
        $this->Fields['typeid'] = $this->typeID_new;
        return $rs;
    }
...
/**
     ...
     * @return int $typeid afterchange
     *
     */
    function MobileTypeidSwitch($typeid){
    ...
    function IsNeedChange(){
     ...
     /**
     *  获得指定ID的typeidr
     *  若是 移动端 栏目需要取 pc端 栏目交叉文档，则此函数获取移动路径
     *  若无需交叉或者是 非移动端 栏目，则此函数取得就是原路径，不影响生成
     * @access    public
     * @return    string typeidr
     */
    function GetCrossOrigTypedir(){
        $orig_typeid = $this->typeID_new;
