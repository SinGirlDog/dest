 ...
 * xml选择框
 *
 * @version        $Id: select_xml.php 1 10:12 2018年11月11日 Sun $
 */
    ...
    //-----计算文件大小和创建时间
                if($file!="." && $file!=".." && !is_dir("$inpath/$file")){
                  ...
                  else if($file == "..")
                  {
                    ...
                    <a href='select_xml.php?xmlstick=$xmlstick&v=$v&f=$f&activepath=".urlencode($tmp).$addparm."'><img src=img/dir2.gif border=0 width=16 height=16 align=absmiddle>上级目录</a></td>
        ...
        <a data='hi' href='select_xml.php?xmlstick=$xmlstick&v=$v&f=$f&activepath=".urlencode("$activepath/$file").$addparm."'><img src=img/dir.gif border=0 width=16 height=16 align=absmiddle>$file</a></td>
        <td class='linerow'>　</td>
...
<tr>
  <td colspan='4' bgcolor='#E8F1DE'>
    ...
    <table width='100%'>
      <form action='select_xml_post.php' method='POST' enctype="multipart/form-data" name='myform'>
        ...
        <input type='hidden' name='xmlstick' value='<?php echo $xmlstick?>'>
        <input type='hidden' name='CKEditorFuncNum' value='<?php echo isset($CKEditorFuncNum)? $CKEditorFuncNum : 1;?>'>
        <input type='hidden' name='job' value='upload'>
        <tr>
          <td background="img/tbg.gif" bgcolor="#99CC00">
            &nbsp;上　传： <input type='file' name='xmlfile' style='width:250px'/>
